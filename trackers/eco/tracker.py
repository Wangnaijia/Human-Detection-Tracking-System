...
class ECOTracker:
    ...
    def track(self, frame, train=True, vis=True):
        # return bbox
        ...
        region = (pos[1] - self._target_sz[1]/2, # xmin
                pos[0] - self._target_sz[0]/2, # ymin
                self._target_sz[1],  # width
                self._target_sz[0])  # height
        self._pos = pos
        self._results.append(region)
        self._frame_num += 1
        return bbox
